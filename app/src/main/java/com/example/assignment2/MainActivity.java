...
public class MainActivity extends AppCompatActivity {
    EditText txtF, txtC, txtKm, txtMi, txtKg, txtLb, txtLiter, txtG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLiter = findViewById(R.id.txtL);
        txtG = findViewById(R.id.txtG);
        txtF = findViewById(R.id.txtF);
        txtC = findViewById(R.id.txtC);
        txtKm = findViewById(R.id.txtKm);
        txtMi = findViewById(R.id.txtM);
        ...
        txtKm.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                try {
                    ...
                    MainActivity.this.txtMi.setText(strM);
        ...
        txtG.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                try {
                    ...
                    MainActivity.this.txtLiter.setText(strL);
